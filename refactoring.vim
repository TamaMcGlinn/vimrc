...
vnoremap <Leader>re :lua require('refactoring').refactor('Extract Function')<CR>
vnoremap <Leader>rf :lua require('refactoring').refactor('Extract Function To File')<CR>
vnoremap <Leader>rt :lua M.refactors()<CR>
